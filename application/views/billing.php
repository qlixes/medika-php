        ...
        <ul class="navbar-nav mr-auto">
          ...
          <li class="nav-item dropdown active">
            ...
            <div class="dropdown-menu">
              <a class="dropdown-item" href="pendaftaran.html">Pendaftaran</a>
              <a class="dropdown-item active" href="visit.html">Rawat Jalan</a>
              ...
              <tr>
                <td>
                  ...
                  <div class="dropdown-menu">
                    ...
                    <a class="dropdown-item" href="">Download Invoice PDF</a>
                    <a class="dropdown-item" href="#">Print Invoice PDF</a>
                  </div>
                </td>
                <td>2013</td>
                <td>1002162</td>
                <td>Abdul Nurhalim</td>
                <td>Rp 2.272.404,00</td>
                <td>Rp 1.246.919,00</td>
