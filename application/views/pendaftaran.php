...
<html lang="en">
  ...
  <body>
        ...
        <ul class="navbar-nav mr-auto">
          ...
          <li class="nav-item dropdown active">
            ...
            <div class="dropdown-menu">
              <a class="dropdown-item active" href="#">Pendaftaran</a>
              <a class="dropdown-item" href="visit.php">Rawat Jalan</a>
    ...
    <ul class="other-menu">
      <li class="active"><a href="pendaftaran.php">Dashboard</a></li>
      <li><a href="rujukan_pendaftaran.php">Rujukan</a></li>
      <li><a href="antrian.php">Antrian</a></li>
      <li><a href="statistic_pendaftaran.php">Statistic</a></li>
    </ul>
        ...
        <div class="col-12">
          <table id="table" class="table table-striped table-bordered">
            ...
            <tbody>
              <tr class="content">
                <td>
                  <a class="nav-link dropdown-toggle" href="" data-toggle="dropdown" aria-haspopup="false" aria-expanded="false"></a>
                  <div class="dropdown-menu">
