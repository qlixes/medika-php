    ...
    <div class="container-fluid">
      <div class="row justify-content-center">
        <ul class="list-group group-instance">
          <a href="detail_instansi.php" class="list-group-item">RSUD Tangerang <span>hospital</span></a>
          <a href="detail_instansi.php" class="list-group-item">RSUD Sentul <span>hospital</span></a>
          <a href="detail_instansi.php" class="list-group-item">RSUD Cibubur <span>hospital</span></a>
